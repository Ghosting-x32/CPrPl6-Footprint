...
{
	//std::cout << "isinzout" << std::endl;
	//std::cout << m_msg.x << " " << m_msg.y << std::endl;
...
void BasicWidget::getmsg(ExMessage& msg)
{
	m_msg = msg;
	//std::cout << "msgfuz" << std::endl;
